...
// //             <button type="submit" className="btn btn-success" style={{ width: "210px" }}>
// //               Register
// //             </button>
// //             <button type="button" className="btn btn-secondary" onClick={handleReset} style={{ width: "210px" }}>
// //               Reset
// //             </button>
// //           </div>
...
const RegistrationForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    try {
      // Dummy save: store in localStorage (like user database)
